...
typedef enum {
    ...
    TY_DISP_ACT_OPEN_DEVICE_MODE,
    TY_DISP_ACT_CLOSE_DEVICE_MODE,
    TY_DISP_ACT_OPEN_RECORD,
    TY_DISP_ACT_CLOSE_RECORD,
    TY_DISP_ACT_OPEN_RECORD_LIST,
    TY_DISP_ACT_CLOSE_RECORD_LIST,
    TY_DISP_ACT_RECORD_START,
    TY_DISP_ACT_RECORD_PAUSE,
    TY_DISP_ACT_RECORD_RESUME,
    TY_DISP_ACT_RECORD_STOP,
    TY_DISP_ACT_RECORD_PLAY,
    TY_DISP_ACT_RECORD_DELETE,
    TY_DISP_ACT_RECORD_UPLOAD,
    TY_DISP_ACT_RECORD_PLAY_PAUSE,
    TY_DISP_ACT_RECORD_PLAY_RESUME,
    TY_DISP_ACT_RECORD_PLAY_STOP,
    TY_DISP_ACT_OPEN_MUSIC,
    TY_DISP_ACT_CLOSE_MUSIC,
    TY_DISP_ACT_OPEN_CALL,
    TY_DISP_ACT_CLOSE_CALL,
    TY_DISP_ACT_OPEN_DETECTION,
    TY_DISP_ACT_CLOSE_DETECTION,
    TY_DISP_ACT_OPEN_SETTINGS,
    TY_DISP_ACT_CLOSE_SETTINGS,
    TY_DISP_ACT_MAX,
} TY_DISPLAY_ACTION_E;
