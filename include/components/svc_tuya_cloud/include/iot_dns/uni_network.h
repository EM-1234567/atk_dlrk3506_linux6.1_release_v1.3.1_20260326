 ...
 * @param[out] ip the ip address of the domain
 * @return OPRT_OK: success, others: fail, please refer to tuya_error_code.h
 */
OPERATE_RET unw_gethostbyname_p(CONST CHAR_T *domain, IN CONST DNS_MODE_E mode, TUYA_IP_ADDR_T *ip);

#define unw_gethostbyname(domain, addr) unw_gethostbyname_p(domain, DNS_IPV4, addr)
