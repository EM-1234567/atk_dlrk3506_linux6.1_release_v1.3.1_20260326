...
typedef enum {
    ...
    /** mqtt heart range */
    HTTP_DYNAMIC_CFG_MQ_HEART_RANGE = 0x0008,
	/** family key */
    HTTP_DYNAMIC_CFG_FAMILY_KEY = 0x0010,
    /** all configs */
 ...
 * @param[in] rateRule_ackId ACK id of dp rate rule
 * @param[in] ability_ackId ACK id of senior ability
 * @param[in] heart_ackId ACK id of mqtt heart beat
 *
 * @return OPRT_OK on success. Others on error, please refer to tuya_error_code.h
 */
OPERATE_RET http_dynamic_cfg_ack_v20(IN CONST CHAR_T* timezone_ackId, IN CONST CHAR_T* rateRule_ackId, IN CONST CHAR_T* ability_ackId, IN CHAR_T* heart_ackId);
