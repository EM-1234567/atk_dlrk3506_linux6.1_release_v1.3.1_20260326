...
#define EVENT_NETCFG_END         "netcfg_end"      // netcfg end event
...
#define EVENT_BLE_CONNECT  "ble.connect"  // ble connect event
#define EVENT_BLE_DISCONNECT  "ble.disconnect"  // ble disconnect event
