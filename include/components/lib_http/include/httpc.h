...
typedef enum  {
    ...
    HDR_ADD_BASE_AUTHENTICATION = 0x0100, /* add basic authentication */
    HDR_ADD_TOKEN_AUTHENITCATION = 0x0200, /* add token authentication*/
    HDR_ADD_ACCEPT_TYPE_JSON = 0x0400, /* add accept type */
