...
/**
 * @brief uninit the link module, release all resources (memory, mutex, sessions, device list, MQTT callback)
 * @return OPRT_OK success, others fail
 */
OPERATE_RET tuya_ipc_tmm_link_uninit(VOID);
